  ...
  return (
    <div className="mx-auto max-w-[1480px] px-5 py-7 sm:px-8 lg:px-10">
      ...
      {filteredStudents.length > 0 ? (
        viewMode === "cards" ? (
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">{filteredStudents.map((student) => <StudentCard key={student.id} student={student} classId={classId} onScore={openScore} onOpen={(studentId) => router.push("/teacher/students/" + studentId)} />)}</div>
        ) : viewMode === "list" ? (
