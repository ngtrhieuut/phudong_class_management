  ...
  async function save(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch(`/api/teacher/students/${studentId}`, {
        ...
        body: JSON.stringify({ classId, studentCode, fullName, birthDate: birthDate || null, gender, seatNo: seatNo ? Number(seatNo) : null, groupName: groupName || null, avatarUrl, classRoleId: classRoleId || null }),
      });
